...
/* Function: hash
 * --------------
 * This function is from Eric Roberts' _The Art and Science of C_, adapted
 * by Julie Zelenski, both at Stanford University. The choice of the value
 * for the multiplier can have a significant impact on the performance of
 * the algorithm, but not on its correctness.
 */
